...
import { snapshotApprovalPayload } from "./snapshotApprovalPayload.js";
...
function snapshotReviewPayload(
  ...
  switch (request.category) {
    ...
    case "remoteToolCall": {
      const payload = request.payload as ApprovalReviewPayloadByCategory["remoteToolCall"];
      return snapshotApprovalPayload("remoteToolCall", payload);
    }
    case "skill": {
