...
export interface RemoteToolApprovalAnnotations {
...
export interface RemoteToolApprovalSource {
...
export interface RemoteToolApprovalServer {
  readonly serverId: string;
  readonly displayName: string;
  readonly registrationFingerprint: string;
  readonly transport: "stdio" | "http" | "https" | "websocket";
  readonly endpoint: {
...
export interface RemoteToolApprovalTool {
...
export interface ApprovalReviewPayloadByCategory {
  ...
  readonly remoteToolCall: ApprovalPayloadByCategory["remoteToolCall"];
