...
const expectedLowerValueExports = {
  ...
  "@agent-anything/tools/validation": [
    "ToolInputSchemaAdmissionError",
    "admitToolInputSchema",
    "formatToolInputValidationFailure",
    "validateToolInput",
  ],
  ...
  "@agent-anything/model-interaction/context": [
    "assessModelContext",
    "createUnknownModelInputMeasurement",
    "snapshotModelContextAssessment",
