...
async function invokeHelarcTarget<TCase extends HelarcEvaluationExecutableCase>(
  ...
  const active = manager.start({
    ...
    runConfig: {
      ...
      runTreeResources: {
        controllerTurns: { maximum: 256, minimumChildGrant: 1, enforcement: "hard" },
        actions: { maximum: 256, minimumChildGrant: 1, enforcement: "hard" },
        modelInputTokens: { threshold: 2_000_000, enforcement: "observational" },
        modelOutputTokens: { threshold: 500_000, enforcement: "observational" },
        costUnits: { threshold: 2_000_000, enforcement: "observational" },
        contextBytes: { maximum: 8_000_000, minimumChildGrant: 1, enforcement: "hard" },
        resultBytes: { maximum: 2_000_000, minimumChildGrant: 1, enforcement: "hard" },
      },
      runTreeApprovals: {
        maxTotalRequests: 8,
