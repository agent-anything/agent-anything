...
const TRIALS: readonly VerificationTrial[] = Object.freeze([
  Object.freeze({
    id: "satisfied-target",
    support: "supported",
    checkAvailable: true,
...
describe("Verification behavior Evaluation profile", () => {
  it("reports Verification dimensions separately and excludes unsupported infrastructure truth", () => {
...
function rate<T extends keyof VerificationTrial>(
  trials: readonly VerificationTrial[],
  key: T,
): number | null {
...
function mean<T extends keyof VerificationTrial>(
  trials: readonly VerificationTrial[],
  key: T,
): number | null {
