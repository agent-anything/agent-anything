export type ValidationBehaviorDimension =
  | "profile"
  | "command_check"
  | "target_state"
  | "evidence"
...
export interface ValidationBehaviorScenario {
  readonly id: string;
  readonly dimension: ValidationBehaviorDimension;
  readonly expected: string;
}

export const VALIDATION_BEHAVIOR_SCENARIOS: readonly ValidationBehaviorScenario[] = deepFreeze([
...
function scenario(
  id: string,
  dimension: ValidationBehaviorDimension,
  expected: string,
): ValidationBehaviorScenario {
