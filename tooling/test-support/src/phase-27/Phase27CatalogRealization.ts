...
export const PHASE27_CATALOG_REALIZATION_REGISTRY = deepFreeze([
  ...
  registered(record("P24-CAP-D002", "helarc.code-workspace", "code.workspace.read_file@1", "direct", "file_system.read", "Phase27", ["P23-S-001", "P23-S-002", "P23-S-011"], runnerEvidence), ["helarc.code-workspace/read-file@1"], ["helarc.code-workspace.file.direct@1"]),
  registered(record("P24-CAP-D003", "helarc.code-workspace", "code.workspace.search_text@1", "direct", "file_system.read", "Phase27", ["P23-S-001", "P23-S-007"], runnerEvidence), ["helarc.code-workspace/search-files@1"], ["helarc.code-workspace.file.direct@1"]),
  registered(record("P24-CAP-D004", "helarc.code-workspace", "code.workspace.change_file@1", "direct", "file_system.write", "Phase27", ["P23-S-002", "P23-S-003", "P23-S-008", "P23-S-009"], ["products/helarc/core/src/review/HelarcPatchActionController.test.ts", ...actionEvidence]), ["helarc.code-workspace/create-file@1", "helarc.code-workspace/update-file@1", "helarc.code-workspace/delete-file@1"], ["helarc.code-workspace.file.direct@1"]),
  ...
  registered(record("P24-CAP-I003", "helarc", "product.proposal.review@1", "internal", "effect_free", "Phase27", ["P23-S-002", "P23-S-003", "P23-S-008"], ["products/helarc/core/src/composition/HelarcPatchReview.test.ts", "products/helarc/core/src/review/HelarcProposalWorkflow.test.ts"]), ["helarc/patch-review@1"], ["helarc.patch-review.protocol@1"]),
...
export const PHASE27_SCENARIO_CONFORMANCE = deepFreeze([
  ...
  scenario("P23-S-002", "Localized defect", ["P24-CAP-D002", "P24-CAP-D004", "P24-CAP-I002", "P24-CAP-I003", "P24-CAP-V003"], ["tooling/test-support/src/evaluation-targets/helarc/HelarcEvaluationTarget.test.ts#controlled-patch"]),
  ...
  scenario("P23-S-008", "Stale conflict", ["P24-CAP-D004", "P24-CAP-D008", "P24-CAP-I003", "P24-CAP-M004"], ["products/helarc/core/src/review/HelarcProposalWorkflow.test.ts"]),
